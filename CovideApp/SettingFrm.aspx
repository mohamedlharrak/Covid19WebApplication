<%@ Page Title="" Language="C#" MasterPageFile="~/MainLayout.Master" AutoEventWireup="true" CodeBehind="SettingFrm.aspx.cs" Inherits="CovideApp.SettingFrm" EnableEventValidation="false" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">


   
    <title>Modifier L'information de votre profil</title>
...
<%--                <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="user avatar">--%>
              ...
              <h5 class="mb-1 text-white">
                  <asp:Label ID="txtNom1" runat="server" Text="test"></asp:Label></h5>
              ...
              <div class="card-body">
                ...
                <li class="list-group-item">
                  ...
                  <div class="list-details">
                    <span>
                        <asp:Label ID="txtNum" runat="server" Text="Label"></asp:Label></span>
                ...
                <li class="list-group-item">
                  ...
                  <div class="list-details">
                    <span>
                        <asp:Label ID="txtEmail" runat="server" Text="Label"></asp:Label></span>
                ...
                <li class="list-group-item">
                  ...
                  <div class="list-details">
                    <span>
                        <asp:Label ID="txtHospital" runat="server" Text="Label"></asp:Label></span>
        ...
        <div class="col-lg-8">
           <div class="card z-depth-3">
            ...
            <ul class="nav nav-pills nav-pills-primary nav-justified">
                <li class="nav-item">
                    <a href="javascript:void();" data-target="#profile" data-toggle="pill" class="nav-link active show"><i class="icon-user"></i> <span class="hidden-xs">Information personnelle</span></a>
                </li>
                
                <li class="nav-item">
                    <a href="javascript:void();" data-target="#edit" data-toggle="pill" class="nav-link"><i class="icon-note"></i> <span class="hidden-xs">Mot de passe</span></a>
                </li>
            </ul>
                ...
                <div class="tab-pane active show" id="profile">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <asp:TextBox ID="txtEmail1" class="form-control" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Changer l'image</label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Address</label>&nbsp;<div class="col-lg-9">
                                <asp:TextBox ID="txtAdrr" style="margin-top: -37px; margin-left: 158px;" class="form-control" runat="server" Width="100%"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
...
<%--                                <asp:TextBox ID="TextBox6" class="form-control" placeholder="City" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="DropDownListVille" class="form-control" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="nom" DataValueField="id"></asp:DropDownList>
                            ...
                            <div class="col-lg-3">
                                <asp:TextBox ID="txtstat" class="form-control" placeholder="State" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
<%--                                <asp:TextBox ID="TextBox6" class="form-control" placeholder="City" runat="server"></asp:TextBox>--%>
                                <asp:DropDownList ID="DropDownListHospital" class="form-control" runat="server" DataSourceID="SqlDataSource2" DataTextField="nom" DataValueField="id"></asp:DropDownList>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <asp:TextBox ID="txtContry" class="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <asp:Button ID="Button1" class="btn btn-primary" runat="server" Text="Enregistrer" OnClick="Button1_Click2"  />
                            </div>
                        </div>
                    </form>
                ...
                <div class="tab-pane" id="edit">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <asp:TextBox ID="txtOldPass" class="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Vouveau mot de passe</label>
                            <div class="col-lg-9">
                                <asp:TextBox ID="txtNewPass" class="form-control" runat="server" AutoPostBack="True" OnTextChanged="txtNewPass_TextChanged"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Confirmez votre nouveau mot de passe</label>
                            <div class="col-lg-9">
                                <asp:TextBox ID="txtConfPass" class="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label"></label>
                            <div class="col-lg-9">
                                <input type="reset" class="btn btn-secondary" value="Annuler">
                                <asp:Button ID="btnSavePass" class="btn btn-primary" runat="server" Text="Enregistrer" OnClick="btnSavePass_Click" />
...
.z-depth-3 {
    ...
    <script type="text/javascript">
        function p() {
            var f = document.querySelector("#FileUpload2");
            var im = f.files[0];
            var r = new FileReader();
            r.onload = function (e) {
                document.querySelector("#Image2").src = e.target.result;
            }
            r.readAsDataURL(im);
        }
    </script>
