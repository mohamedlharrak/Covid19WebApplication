<%@ Page Title="Modifier Information Admin" Language="C#" MasterPageFile="~/MainLayout.Master" AutoEventWireup="true" CodeBehind="AdminUpdateFrm.aspx.cs" Inherits="CovideApp.AdminUpdateFrm" EnableEventValidation="false" ValidateRequest="false"%>
    ...
    <div class="auto-style1">
        ...
        <br />
         <div class="input-group" style="width:500px; margin:auto;">
                            ...
                            <div class="input-group-append">
                                    <asp:LinkButton class="btn btn-primary" ID="btnSearch" ToolTip="LinkButton1" runat="server" Text='<i class="fas fa-search fa-sm"></i>' OnClick="LinkButton1_Click1" ></asp:LinkButton>
        ...
        <form action="#">
            ...
            <div class="form-row">
               ...
               <div class="input-data">
                  <div class="inner"></div>
                   <asp:Button ID="Modifier" runat="server" Text="Modifier" OnClick="Modifiere"  />
