<%@ Page Title="" Language="C#" MasterPageFile="~/MainLayout.Master" AutoEventWireup="true" CodeBehind="HospitalUpdateFrm.aspx.cs" Inherits="CovideApp.HospitalUpdateFrm" %>
    ...
    <div class="auto-style1">
        ...
        <form action="#">
            ...
            <div class="form-row">
                ...
                <div class="input-data">
                 <asp:DropDownList ID="DropDownListVille" runat="server" BackColor="#F8F9FC" class="drop" Height="33px" Width="490px" ForeColor="#858796" style="border:0px;outline:0px;" >
            ...
            <div class="form-row">
               ...
               <div class="input-data">
                  <div class="inner"></div>
                   <asp:Button ID="btnEdite" runat="server" Text="Modifier" OnClick="btnEdite_Click"/>
