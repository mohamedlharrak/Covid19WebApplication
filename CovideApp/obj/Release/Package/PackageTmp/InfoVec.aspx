<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoVec.aspx.cs" Inherits="CovideApp.InfoVec" %>
...
<div class="row">
        ...
        <div class="profile-card-4 z-depth-3">
         <div class="card">
           ...
           <h5 class="mb-1 text-white">
               <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label></h5>
           <h6 class="text-light">
               <asp:Label ID="Label5" runat="server" Text="Label"></asp:Label></h6>
          </div>
           <div class="card-body">
             ...
             <li class="list-group-item">
               ...
               <div class="list-details">
                 ...
                 <small>
                     <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></small>
               </div>
             </li>
             <li class="list-group-item">
               <div class="list-icon">
               ...
               <div class="list-details">
                 <span>Ville</span>
                 <small>
                     <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></small>
               </div>
             </li>
             <li class="list-group-item">
               <div class="list-icon">
               ...
               <div class="list-details">
                 <span>Adress</span>
                 <small>
                     <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label></small>
               </div>
             </li>
             </ul>
  ...
  <%--<form>--%>
        <form runat="server" class="col-lg-8">
           <div class="card z-depth-3">
            ...
            <ul class="nav nav-pills nav-pills-primary nav-justified">
                ...
                <li class="nav-item">
                    <a href="javascript:void();" data-target="#edit" data-toggle="pill" class="nav-link"><i class="icon-note"></i> <span class="hidden-xs">Sciences de vaccin</span></a>
                </li>
            </ul>
            <div class="tab-content p-3">
                <div class="tab-pane active show" id="profile">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox1" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Prénom</label>
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox2" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">CIN</label>
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox3" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Genre</label>
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox4" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox5" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Ville</label>
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox11" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Address</label>
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox6" runat="server"></asp:TextBox>
                            </div>
                        </div>
                ...
                <div class="tab-pane" id="edit">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Hospital</label>
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox7" runat="server"></asp:TextBox>
                            </div>
                        </div>
                       
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">première séance de vaccins</label>
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox8" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Deuxième séance de vaccins</label>
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox9" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Vaccins</label>
                            <div class="col-lg-9">
                                <asp:TextBox ReadOnly="true" class="form-control" ID="TextBox10" runat="server"></asp:TextBox>
                            </div>
                        </div>
